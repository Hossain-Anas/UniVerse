      ...
      <NavigationMenu.List class="flex gap-6 p-4 justify-center">
        ...
        <NavigationMenu.Item>
          ...
          <NavigationMenu.Content>
            <ul class="grid w-[140px] gap-1 p-2 bg-[hsl(222.2_47.4%_11.2%)] text-white rounded-md">
              <li>
                <NavigationMenu.Link href="/auth/logout" class="px-2 py-1 rounded">Logout</NavigationMenu.Link>
              </li>
            </ul>
          </NavigationMenu.Content>
        </NavigationMenu.Item>
